Pod::Spec.new do |s|
  ...
  s.version      = "0.1.0"
  s.summary      = "RSALibraryTypeFramework."
  s.description  = <<-DESC
  RSALibraryTypeFramework TEST
  DESC
  ...
  s.source       = { :git => "https://github.com/MyeongJin-rowem/RSALibraryTypeFramework.git", :tag => "#{s.version}" }
  ...
  s.platform = :ios
  s.swift_version = "4.2"
  s.ios.deployment_target  = '11.0' #pod 최소타겟
